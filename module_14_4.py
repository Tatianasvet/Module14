...
reply_kb = ReplyKeyboardMarkup(keyboard=[[button_1, button_2], [button_3]], resize_keyboard=True)
...
async def start_message(message: types.Message):
    ...
    await message.answer("Чтобы посчитать калории нажмите Рассчитать", reply_markup=reply_kb)
